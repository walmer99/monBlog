...
class __TwigTemplate_b8e6ed8bbfe99aaee96a1bac2d7fba224b790e5b89b24af3ee3258d0cbdf1039 extends \Twig\Template
{
    ...
    ";
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["article"]) {
            ...
            echo " - Category : ";
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, $context["article"], "category", [], "any", false, false, false, 14), "name", [], "any", false, false, false, 14), "html", null, true);
            echo "</h2>
            <p>";
            // line 15
            echo twig_escape_filter($this->env, twig_slice($this->env, twig_get_attribute($this->env, $this->source, $context["article"], "content", [], "any", false, false, false, 15), 0, 150), "html", null, true);
            echo "</p>
            <a href=\"";
            // line 16
            echo twig_escape_filter($this->env, twig_lower_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("blog_show", ["slug" => twig_replace_filter(twig_get_attribute($this->env, $this->source, $context["article"], "title", [], "any", false, false, false, 16), [" " => "-"])])), "html", null, true);
            echo "\">Read more</a>
        </div>
    ";
...
";
    ...
    {
        return array (  155 => 21,  148 => 19,  132 => 16,  128 => 15,  120 => 14,  117 => 13,  99 => 12,  94 => 10,  89 => 8,  84 => 7,  75 => 6,  57 => 4,  35 => 2,);
    }
...
{% block body %}
    ...
    {% for article in articles %}
        <div>
            ...
            <a href=\"{{ path('blog_show',{'slug':article.title | replace({\" \":\"-\"})}) | lower }}\">Read more</a>
        </div>
    {% else %}
...
", "blog/index.html.twig", "/var/www/html/monBlog/templates/blog/index.html.twig");
    }
}
